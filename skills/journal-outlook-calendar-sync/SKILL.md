...
7. Verify.
   - First report the coverage record: `24/24 hourly windows completed` and the union count. If it is not exactly `24/24`, the sync is incomplete; do not report success and do not leave partial edits unaddressed.
